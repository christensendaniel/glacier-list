...
def basic_example():
    """Run a basic example of GlacierList usage."""
    print("Basic GlacierList Example")
    print("=========================")

    # Create a GlacierList with small chunk size for demonstration
    cl = GlacierList(chunk_size=5, disk_path="example_data")
...
def performance_example():
    ...
    cl = GlacierList(chunk_size=10000, disk_path="perf_data")
