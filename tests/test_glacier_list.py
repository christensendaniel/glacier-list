"""
Comprehensive tests for GlacierList functionality.
"""
...
def test_glacier_list_initialization():
    """Test GlacierList initialization with different parameters."""
    with tempfile.TemporaryDirectory() as temp_dir:
        cl = GlacierList(chunk_size=1000, disk_path=temp_dir, auto_cleanup=False)
...
def test_glacier_list_append_and_length():
    """Test appending items and length calculation."""
    with tempfile.TemporaryDirectory() as temp_dir:
        cl = GlacierList(chunk_size=3, disk_path=temp_dir, auto_cleanup=False)
...
def test_glacier_list_indexing():
...
def test_glacier_list_iteration():
...
def test_glacier_list_contains():
    """Test 'in' operator."""
    with tempfile.TemporaryDirectory() as temp_dir:
        cl = GlacierList(chunk_size=3, disk_path=temp_dir, auto_cleanup=False)
...
def test_glacier_list_serialization():
    """Test serialization functionality."""
    with tempfile.TemporaryDirectory() as temp_dir:
        cl = GlacierList(chunk_size=2, disk_path=temp_dir, auto_cleanup=False)
...
def test_glacier_list_operations():
...
def test_glacier_list_error_handling():
    """Test error handling."""
    with tempfile.TemporaryDirectory() as temp_dir:
        cl = GlacierList(chunk_size=3, disk_path=temp_dir, auto_cleanup=False)
