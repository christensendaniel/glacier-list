...
def test_glacier_list_basic():
    """Test basic GlacierList functionality."""
...
def test_glacier_list_properties():
    """Test GlacierList properties."""
    with tempfile.TemporaryDirectory() as temp_dir:
...
def test_glacier_list_context_manager():
    """Test GlacierList as context manager."""
    with tempfile.TemporaryDirectory() as temp_dir:
        with GlacierList(chunk_size=2, disk_path=temp_dir) as cl:
            cl.append({"id": 1})
            cl.append({"id": 2})
